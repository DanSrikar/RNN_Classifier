...
# installed.
TCL_PREFIX='F:/Generative AI Course With Langchain and Huggingface/14 - End To End Deep Learning Projects With Simple RNN/RNNProject/venv\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='F:/Generative AI Course With Langchain and Huggingface/14 - End To End Deep Learning Projects With Simple RNN/RNNProject/venv\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='F:/Generative AI Course With Langchain and Huggingface/14 - End To End Deep Learning Projects With Simple RNN/RNNProject/venv\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IF:/Generative AI Course With Langchain and Huggingface/14 - End To End Deep Learning Projects With Simple RNN/RNNProject/venv\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LF:/Generative AI Course With Langchain and Huggingface/14 - End To End Deep Learning Projects With Simple RNN/RNNProject/venv\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='F:/Generative AI Course With Langchain and Huggingface/14 - End To End Deep Learning Projects With Simple RNN/RNNProject/venv\Library\lib\tclstub86.lib'
